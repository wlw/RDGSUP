...
import com.bricksimpe.rdg.Xbrlutil.ConfidenceLevel;
import com.bricksimpe.rdg.Xbrlutil.MatchStr;
...
public class MySqlAccess {
		...
		try {
			...
			if(rs.next() == false) {
			    ...
			    query = "INSERT into SubmissionHistory (SubUid, SrcFile, ExtractFile, Version, Date, FiscalPeriod, PublicFloat, " +
			            ...
			            "IsAmendment, DeiTaxonomyUid, TaggingType, InvestTaxonomyUid, UpdateXMLFilePath) VALUES  (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
			    pstmt = con.prepareStatement(query);
			    ...
			    pstmt.setInt(15, rs.getInt(23));
			    pstmt.setInt(16, rs.getInt(26));
			    pstmt.setString(17, rs.getString(27));
	...
	public int WriteAppError(Connection con, ErrorCls errorCls) {  // static
		...
		try {
			...
			pstmt.setString(4,"XbrlEdgarExtraction");
